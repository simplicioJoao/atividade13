...
// - Serviços são componentes do Spring usados para encapsular a lógica central da aplicação.
...
public class UserService {
    ...
    public UserDTO getUserById(int id) { // Ajustamos o tipo de int para Long
    ...
    public UserDTO updateUser(int id, UserDTO userDTO) { // Ajustamos o tipo de int para Long
    ...
    public void deleteUser(int id) { // Ajustamos o tipo de int para Long
